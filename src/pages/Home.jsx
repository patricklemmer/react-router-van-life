...
function Home() {
  return (
    <div className="home-container pt-6 pb-10 px-4 text-left text-white min-h-screen xxs:pt-8 xxs:pb-12 xxs:px-8 sm:pt-10 sm:pb-14 sm:px-10">
      <section className="grid gap-4 sm:max-w-2xl sm:mx-auto">
        ...
        <div className="flex justify-center items-center max-w-8/12 mx-auto xxs:w-8/12">
          <Link
            to="vans"
            className="w-full bg-orange-500 py-2 px-4 rounded-md font-bold text-center xxs:text-lg sm:text-xl"
          >
            Find your van
          </Link>
        </div>
